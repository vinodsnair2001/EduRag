...
| `<ClassSubjectSelectPage />` | student/pages/ClassSubjectSelectPage.tsx | Shows student's assigned class + permitted subjects; calls `GET /student/my-class` and `GET /student/my-subjects` |
